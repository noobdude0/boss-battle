...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.PlayerShot, function (sprite, otherSprite) {
    if (started) {
        ...
        if (bossLife <= 0) {
            story.printDialog("NOOOOOOOOOOOOOOOOOOOOOOOOOO", 80, 90, 50, 150)
            game.over(true)
...
let globalY = 0
let globalX = 0
story.printDialog("Boss: you dare challenge me mortal?", 90, 80, 50, 150)
story.printDialog("You: With the power of.....", 80, 90, 50, 150)
story.printDialog("Blah Blah Blah Blah. Lets just fight", 80, 90, 50, 150)
callbossfight()
